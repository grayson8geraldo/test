...
return [
    ...
    // Параметр НЕОБЯЗАТЕЛЕН: если оставить пустым или удалить — будет
    // использоваться значение из настроек ЛКК Робокассы (рекомендуется).
    // Передавайте только если хотите принудительно переопределить.
    // Возможные значения:
    //   osn                 — общая
